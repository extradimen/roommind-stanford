...
ADJ = Path("research/experiments/2026-09-15-g5-fresh-family-v17-reference-adjudication-preflight")
...
EXPECTED_FREEZE_SHA = "0f1b69f154f5ad7472f62b3b63c941d73b3a0698eda46e5276da1f5341040460"
EXPECTED_PACKET_SHA = "4e2ebcfdcc5cfd18075470befb0a12cc4d4b1fce8ff8d82aa6ef134f66f6fc6f"
...
def main():
    ...
    if (set(submission) != {"schema", "packet_sha256", "reviewer", "rows"}
            or submission["schema"] != "g5-fresh-v17-ai-reference-adjudication-submission-v1"
            or submission["packet_sha256"] != EXPECTED_PACKET_SHA
            or submission["reviewer"] != {"id": "codex-independent-v17-adjudicator", "kind": "ai"}):
    ...
    raw = {"schema": "g5-fresh-v17-two-ai-development-reference-v1",
