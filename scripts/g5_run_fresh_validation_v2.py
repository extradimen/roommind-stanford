#!/usr/bin/env python3
"""Bind and resume the authorized eight-dialogue fresh-family v2 pilot."""
import argparse
import asyncio
import fcntl
import json
...
from app.g5.fresh_execution_v2 import execution_binding, run_execution
...
def main():
    ...
    parser.add_argument("--credential-source", required=True,
                        help="Explicit dotenv file; its contents are never serialized")
    ...
    try:
        ...
        execution = execution_binding(args.source_revision,
