#!/usr/bin/env python3
"""Freeze untouched scorer-v3 worlds, roles, and assignments; no model calls."""
import argparse
import json
import os
...
def main():
    ...
    values = {"frame.json": validate_fresh_family_frame_v3(fresh_family_frame_v3()),
              "roles.json": validate_fresh_family_role_pack_v3(fresh_family_role_pack_v3()),
              "scorer-validation-plan.json":
                  validate_fresh_validation_plan_v3(fresh_validation_plan_v3())}
