#!/usr/bin/env python3
"""Run an explicitly authorized v15 scorer-v4 validation dialogue batch."""
import argparse
import asyncio
import fcntl
import json
...
from app.g5.fresh_execution_v15 import execution_binding, run_execution
...
def main():
    ...
    parser.add_argument("--predecessor-gate-result-sha256", required=True)
    ...
    try:
        ...
        execution = execution_binding(
            ...
            predecessor_gate_result_sha256=args.predecessor_gate_result_sha256,
        )
