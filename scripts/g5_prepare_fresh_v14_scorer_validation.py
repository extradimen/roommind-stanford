#!/usr/bin/env python3
"""Prepare the sealed v14 development dialogues for blinded review and scoring.
...
SOURCE = Path("research/experiments/2026-09-14-g5-fresh-family-v14-development-online")
TARGET = Path("research/experiments/2026-09-14-g5-fresh-family-v14-scorer-preflight")
EXECUTION_SHA = "89ccb30ec547c1542597f3c16aca143905b6c15fd3e604a951877f4d68e49354"
TRANSCRIPTS_SHA = "f9a626e5ba3be2310d955d3ff2c5d16e397cb8562b20c788409ce88563c72994"
...
def main():
    ...
    predictor = CatalogEvidencePredictor(binding,
        ...
        predictor_id="g5-fresh-v14-development-scorer-20260914", kind="ai")
    plan = predictor.plan()
    cases, source_files = [], {}
    for assignment in sorted(execution["selected_assignments"], key=lambda item: item["scenario_id"]):
        ...
        for dimension, rubric in RUBRICS.items():
            task = {"case_id": f"fresh-v14-{scenario_id}-{dimension}",
    ...
    bundle = {"schema": "g5-fresh-v14-scorer-inputs-v1",
        ...
        "selection": "All eight sealed v14 development dialogues and all six dimensions; no score-based filtering.",
    ...
    distribution = {"schema": "g5-fresh-v14-reference-distribution-plan-v1",
    ...
    summary = {"schema": "g5-fresh-v14-scorer-preflight-summary-v1",
