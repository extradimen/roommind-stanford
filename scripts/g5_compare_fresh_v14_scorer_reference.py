#!/usr/bin/env python3
"""Apply the prospectively frozen scorer-v3 gate to the v14 validation."""
...
PLAN = Path("research/experiments/2026-09-13-g5-scorer-v3-prospective-plan/plan.json")
PRE = Path("research/experiments/2026-09-14-g5-fresh-family-v14-scorer-preflight")
REF = Path("research/experiments/2026-09-14-g5-fresh-family-v14-reference-adjudication-preflight/final-ai-reference.json")
...
EXPECTED_PLAN_SHA = "806c776d6452177cef4222c9d8d9c2327ed8aeb0bc11c206893d4c6e521cde66"
EXPECTED_INPUT_SHA = "3c6a948f396fa7d68426df10b506f342188eccf8b57088701c7e841e11744f48"
EXPECTED_REFERENCE_SHA = "d2c4420fc6d7241b315bd6ff53c0b0663ffcb60403c76c224e74a6c8f045e934"
EXPECTED_AUDIT_SHA = "d8c1e80b570a5864fd10d8c6dd6bfcd0d3a11a82539b5faffdf7353a71ceac75"
...
def main():
    ...
    raw = {
        "schema": "g5-fresh-v14-ai-reference-comparison-and-prospective-gate-v1",
