...
TARGET = Path("research/experiments/2026-09-15-g5-fresh-family-v17-reference-adjudication-preflight")
...
def main():
    ...
    if (inputs.get("sha256") != EXPECTED_INPUT_SHA
        ...
        raise ValueError("V17 scorer inputs changed")
    if PRE.parent.joinpath("2026-09-15-g5-fresh-family-v17-scorer-predictions").exists():
    ...
    raw_packet = {"schema": "g5-fresh-v17-ai-reference-adjudication-packet-v1",
    ...
    raw_coord = {"schema": "g5-fresh-v17-ai-reference-adjudication-coordinator-v1",
    ...
    template = {"schema": "g5-fresh-v17-ai-reference-adjudication-submission-v1",
    ...
    counts = {letter: dict(sorted(Counter(row["label"] for row in submission["rows"]).items()))
              for letter, submission in zip("ab", submissions)}
    raw_summary = {"schema": "g5-fresh-v17-ai-reference-freeze-v1",
