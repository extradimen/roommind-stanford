...
/** Same-origin transcoder — avoids CDN latency/blocking for Basis textures. */
...
/** Reuse one KTX2 loader per renderer — creating many instances breaks sequential parses. */
...
/** Block GLB parse until the Canvas WebGL context has initialized. */
