"""v17 recovery binding tests; no model or network calls."""
import unittest

from app.g5.fresh_execution_v17 import execution_binding
from app.g5.fresh_validation_plan_v4 import fresh_validation_plan_v4


class FreshExecutionV17Tests(unittest.TestCase):
    def test_recovery_is_bound_and_keeps_frozen_conditions(self):
        value = execution_binding("a" * 40, authorization_id="fixture",
                                  predecessor_execution_sha256="b" * 64)
        self.assertEqual(value["schema"], "g5-fresh-family-v17-execution-binding-v1")
