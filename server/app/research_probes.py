...
def run_integrity_probes(full_bundle: dict[str, Any]) -> dict[str, Any]:
    ...
    generations = tuple(f"g4.{number}" for number in range(1, 17))
    is_g41_roommind = session_mode == "test" and architecture_version.startswith(generations)
    is_g42_roommind = session_mode == "test" and architecture_version.startswith(generations[1:])
    is_g43_roommind = session_mode == "test" and architecture_version.startswith(generations[2:])
    is_g44_roommind = session_mode == "test" and architecture_version.startswith(generations[3:])
    is_g45_roommind = session_mode == "test" and architecture_version.startswith(generations[4:])
    is_g47_roommind = session_mode == "test" and architecture_version.startswith(generations[6:])
    is_g48_roommind = session_mode == "test" and architecture_version.startswith(generations[7:])
    is_g49_roommind = session_mode == "test" and architecture_version.startswith(generations[8:])
    is_g410_roommind = session_mode == "test" and architecture_version.startswith(generations[9:])
    is_g411_roommind = session_mode == "test" and architecture_version.startswith(generations[10:])
    is_g412_roommind = session_mode == "test" and architecture_version.startswith(generations[11:])
    is_g413_roommind = session_mode == "test" and architecture_version.startswith(generations[12:])
    is_g414_roommind = session_mode == "test" and architecture_version.startswith(generations[13:])
    is_g415_roommind = session_mode == "test" and architecture_version.startswith(generations[14:])
    ...
    checks = {
        ...
        "g413_response_terminal_and_grounding_converged": (
