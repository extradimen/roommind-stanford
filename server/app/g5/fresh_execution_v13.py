"""Versioned recovery restoring the qualified structured-output revision budget."""
from app.factorial_study import digest
from app.g5.fresh_execution_v12 import execution_binding as _base_binding, run_execution
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    value = _base_binding(
        ...
        max_structured_revisions=3,
    )
    raw = {key: item for key, item in value.items() if key != "sha256"}
    raw.update(
        schema="g5-fresh-family-v13-execution-binding-v1",
        predecessor_execution_sha256=predecessor_execution_sha256,
        recovery_reason="restore_qualified_structured_revision_budget_for_untouched_families",
    )
