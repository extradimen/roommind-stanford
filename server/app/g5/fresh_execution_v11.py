"""Versioned recovery with conservative structured-output exhaustion policies."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(schema="g5-fresh-family-v11-execution-binding-v1",
               predecessor_execution_sha256=predecessor_execution_sha256,
               recovery_reason="conservative_governance_rejection_after_repair_exhaustion")
