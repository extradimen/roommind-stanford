"""Versioned recovery adding exact question-annotation field repair feedback."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(
        schema="g5-fresh-family-v14-execution-binding-v1",
        predecessor_execution_sha256=predecessor_execution_sha256,
        recovery_reason="exact_question_annotation_field_repair_feedback",
    )
