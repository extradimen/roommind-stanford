"""Bound, resumable execution for the eight-dialogue fresh-family v15 scorer-validation pilot.
...
DEFAULT_ENDPOINT = "ollama-cloud-g5-fresh-v15"
DEFAULT_MAX_STEPS = 16
DEFAULT_MAX_REVISIONS = 1
V14_GATE_RESULT_SHA = "d50bb9eeadf540d28de3e12a1de945e12c6b381e9461db86bedf3fcf2ad74c31"
...
def _components(binding, transport, *, max_plan_revisions=0, max_question_revisions=0,
    ...
    cognition = ReflectiveCognition(
        ...
        reflector_id="ollama-g5-fresh-v15-reflection",
        planner_id="ollama-g5-fresh-v15-hierarchical-updates",
        hierarchical=True,
        plan_updates=True,
        max_active_tasks=64,
    ...
    governance = CandidateGovernance(
        ModelAuditor(binding, transport), auditor_id="ollama-g5-fresh-v15-auditor",
...
def execution_binding(source_revision, *, model=DEFAULT_MODEL, endpoint_id=DEFAULT_ENDPOINT,
                      ...
                      authorization_id, predecessor_gate_result_sha256,
                      reasoning_effort="low", max_plan_revisions=0,
                      max_question_revisions=0, max_structured_revisions=3):
    ...
    if predecessor_gate_result_sha256 != V14_GATE_RESULT_SHA:
        raise ValueError("Exact failed v14 gate result required")
    ...
    frame, roles, plan = (fresh_family_frame_v4(), fresh_family_role_pack_v4(),
                          fresh_validation_plan_v4())
    ...
    design = {
        ...
        "used_families": ["incident", "interview", "launch", "negotiation",
            "library-space-allocation", "research-data-release", "museum-loan-conservation",
            "community-transit-adjustment", "coastal-shelter-activation",
            "field-expedition-launch", "municipal-water-advisory",
            "microgrid-service-handover"],
        "repetitions": 1,
        "order_seed": 20260914,
    ...
    raw = {
        "schema": "g5-fresh-family-v15-execution-binding-v1",
        "classification": "development-validation-only",
        "authorization_id": authorization_id,
        "predecessor_gate_result_sha256": predecessor_gate_result_sha256,
...
async def run_execution(execution, output, *, api_key, base_url="https://ollama.com",
    ...
    manifest, frame, roles = (execution["manifest"], fresh_family_frame_v4(),
                              fresh_family_role_pack_v4())
    ...
    try:
        ...
        raw = {"schema": "g5-fresh-family-v15-public-transcripts-v1",
