"""Versioned recovery after v6 engineering qualification exhausted two revisions."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(schema="g5-fresh-family-v7-execution-binding-v1",
               predecessor_execution_sha256=predecessor_execution_sha256,
               recovery_reason="qualification_bound_increased_after_mixed_validation_failures")
