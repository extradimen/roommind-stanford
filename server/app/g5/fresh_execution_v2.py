"""Bound, resumable execution for the eight-dialogue fresh-family v2 pilot.
...
from app.g5.fresh_validation_plan_v2 import fresh_validation_plan_v2
...
DEFAULT_ENDPOINT = "ollama-cloud-g5-fresh-v2"
...
def _components(binding, transport):
    ...
    cognition = ReflectiveCognition(
        ...
        reflector_id="ollama-g5-fresh-v2-reflection",
        planner_id="ollama-g5-fresh-v2-hierarchical-updates",
        hierarchical=True,
        plan_updates=True,
        max_active_tasks=64,
    )
...
def execution_binding(source_revision, *, model=DEFAULT_MODEL, endpoint_id=DEFAULT_ENDPOINT,
    ...
    frame, roles, plan = (fresh_family_frame_v2(), fresh_family_role_pack_v2(),
                          fresh_validation_plan_v2())
    ...
    raw = {
        "schema": "g5-fresh-family-v2-execution-binding-v1",
...
async def run_execution(execution, output, *, api_key, base_url="https://ollama.com",
    ...
    manifest, frame, roles = (execution["manifest"], fresh_family_frame_v2(),
    ...
    try:
        ...
        raw = {"schema": "g5-fresh-family-v2-public-transcripts-v1",
