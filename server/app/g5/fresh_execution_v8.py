"""Versioned recovery with actor-excluding question target repair metadata."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(schema="g5-fresh-family-v8-execution-binding-v1",
               predecessor_execution_sha256=predecessor_execution_sha256,
               recovery_reason="exclude_actor_from_question_repair_targets")
