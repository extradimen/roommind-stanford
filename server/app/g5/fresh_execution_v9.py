"""Versioned recovery with an explicit conservative planning repair option."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(schema="g5-fresh-family-v9-execution-binding-v1",
               predecessor_execution_sha256=predecessor_execution_sha256,
               recovery_reason="explicit_safe_no_change_planning_repair")
