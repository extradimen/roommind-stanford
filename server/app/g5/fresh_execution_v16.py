"""Versioned recovery adding exact cognitive source-ID copy feedback."""
...
def execution_binding(source_revision, *, authorization_id, predecessor_execution_sha256):
    ...
    raw.update(
        schema="g5-fresh-family-v16-execution-binding-v1",
        predecessor_execution_sha256=predecessor_execution_sha256,
        recovery_reason="exact_cognitive_source_id_copy_feedback",
    )
